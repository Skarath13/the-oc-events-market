...
ownerContributionNeeded:
  - Actual timeline fields and approval process
  - Communication cadence
  - Real dependency and escalation examples
proposedOutline:
  - Why a vendor list is not a production plan
...
assetsNeeded:
  ...
  - Dependency diagram
factsToVerify:
  - Actual workflow and tools
  - Communication promises
conversionCta: Bring every approved vendor into one clear plan.
draft: true
---
